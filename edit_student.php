...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="classesDropdown" role="button" data-toggle="dropdown"
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="studentsDropdown" role="button" data-toggle="dropdown"
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="resultsDropdown" role="button" data-toggle="dropdown"
    ...
    <div class="container mt-4">
        ...
        if (isset($_POST['student_name'], $_POST['roll_no'])) {
            ...
            $sql = "UPDATE `student` SET `sname`='$studentName', `class`='$class_name' WHERE `rno`='$rollNo'";
